...
const messagesSetActivity = async (vk: VK, peerId: number, type: MessagesActivityType): Promise<MessagesSetActivityResponse> => {
  return await makeVkRequest(
    'mmessages.setActivity',
    vk.accessToken,
    messageSetActivityDecoder,
    {
      type,
      peer_id: peerId,
    }
